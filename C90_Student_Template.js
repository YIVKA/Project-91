	...
	function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		conaole.log("When up arrow is pressed, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_down()
{
	...
	{
		car1_y = car1_y - 10;
		conaole.log("When down arrow is pressed, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1_x = car1_x - 10;
		conaole.log("When left arrow is pressed, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1_x = car1_x - 10;
		conaole.log("When right arrow is pressed, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
